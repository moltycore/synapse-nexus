    ...
    <div className="fixed bottom-0 left-0 right-0 p-4 bg-gradient-to-t from-background via-background/95 to-transparent pb-6 z-50">
      <div className="max-w-3xl mx-auto relative">
        ...
        >
          ...
          {/* YENİ EKLENEN SOL MOD BUTONU (Solo / Nexus) */}
          <button
            type="button"
          ...
          <textarea
            ...
            className="flex-1 max-h-[120px] min-h-[40px] bg-transparent border-none focus:ring-0 resize-none text-sm text-foreground/90 placeholder:text-white/30 py-2.5 px-4 outline-none overflow-y-auto"
            rows={1}
            style={{
              scrollbarWidth: 'none',
