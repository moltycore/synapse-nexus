      ...
      <div className="max-w-3xl mx-auto relative">
        ...
        >
          <textarea
            ...
            className="flex-1 max-h-[120px] min-h-[40px] bg-transparent border-none focus:ring-0 resize-none text-sm text-foreground/90 placeholder:text-white/10 py-2.5 px-4 outline-none overflow-y-auto"
            rows={1}
            style={{
              scrollbarWidth: 'none',
